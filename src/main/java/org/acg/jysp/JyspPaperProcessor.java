...
public class JyspPaperProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        String baseSrc = "D:\\temp\\jysp\\";
        String subSrc = url.replace("https://www.chsi.com.cn/jyzx/jysp/", "").substring(0, 4);
    ...
    public static void buildPaper(String url) {
        Spider.create(new JyspPaperProcessor()).addUrl(url)
                .addPipeline(new ConsolePipeline()).run();
    }

//    public static void main(String[] args) {
//        Spider.create(new JyspPaperProcessor()).addUrl("https://www.chsi.com.cn/jyzx/jysp/202010/20201022/1985743097.html")
//                .addPipeline(new ConsolePipeline()).run();
//    }
}
